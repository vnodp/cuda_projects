...
int main(){
  ...
  cudaCheckErrors("cudaMalloc failure d_A"); // error checking
  cudaMalloc(&d_B, DSIZE*sizeof(float));
  cudaCheckErrors("cudaMalloc failure d_B"); // error checking
  cudaMalloc(&d_C, DSIZE*sizeof(float));
  cudaCheckErrors("cudaMalloc failure d_C"); // error checking
